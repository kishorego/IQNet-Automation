...
def Get_Spirent_Config():
    print(file_path + '\..\libraries\Spirent_Test_Topology.yaml')
...
class Spirent_L2_Traffic_Gen:
    ...
    def Break_Link(self, src_port_handle_index, flag):
        print(self.port_handle[src_port_handle_index])
        if flag == 'SHUT':
            print("Shutting the Port")
...
#Spirent_L2_Gen.Break_Link(0, "SHUT")
#time.sleep(60)
#Spirent_L2_Gen.Break_Link(0, "NO_SHUT")
